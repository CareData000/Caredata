<?php 
    ...
    if (isset($_SESSION['user_login'])) {
        ...
        $stmt = $conn->prepare("SELECT * FROM users WHERE id = :user_id"); // ใช้ prepared statement
        $stmt->bindParam(':user_id', $user_id, PDO::PARAM_INT); // ผูกค่าของ user_id
        $stmt->execute();
...
<body>
    ...
    <!-- แถบเมนู -->
    <div class="navbar">
        <a href="medicine_user.html">คลังยา</a>
        <a href="image.html">สมาชิกผู้ดูแล</a>
        <a href="index.html">เตียงนอนพักผ่อน</a>
    </div>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h3>ยินดีต้อนรับคุณ <?php echo $row['firstname']; ?></h3>
            </div>
            <div class="card-body">
                <h4>ข้อมูลบัญชี</h4>
    ...
    <footer class="footer">
        <p>&copy; 2025 CareData. All Rights Reserved.</p>
    </footer>
